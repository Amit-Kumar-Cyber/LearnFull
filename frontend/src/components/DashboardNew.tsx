...
export function DashboardNew({
  ...
  const { xp, level, user, signOut } = useStore();
    ...
    <div className="flex h-screen bg-[#0F0F1E] overflow-hidden">
      ...
      <div className="w-48 bg-[#1A1A2E] border-r border-white/10 flex flex-col">
        ...
        <div className="p-4 border-t border-white/10">
          <button 
            onClick={() => signOut()}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#FF6B6B] text-white rounded-lg hover:bg-[#FF5757] transition-colors"
          >
        ...
        <div className="bg-[#1A1A2E] border-b border-white/10 p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="w-10 h-10 bg-gradient-to-br from-[#5B5FFF] to-[#7B61FF] rounded-full flex items-center justify-center" title={user?.email || 'User'}>
